...
- Inline image rendering from markdown via [ratatui-image](https://github.com/ratatui/ratatui-image), using the terminal's native graphics protocol (kitty/sitixel/iterm2) with an aspect-correct fit; terminals without graphics support show a short hint instead.
